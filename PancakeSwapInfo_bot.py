...
def start_command(message):
    ...
    bot.send_message(cid, "🔰 გამარჯობა 🥳 მე PancakeSwap-ის ბოტი ვარ და შემიძლია შენი მისამართით გაგიგო რომელ Pool-ში რამდენი ტოკენი დააგროვე და ასევე " + \
                          ...
                          "🔰 ჯერ მხოლოდ 9 Pool-ზე შემიძლია ინფორმაცია მოგაწოდო: *CAKE, bOPEN, DODO, SWINGBY, BRY, ZEE, SWGB, SFP, LINA, LIT, HGET, BDO, EGLD, UST და DITTO.*" + "\n" + "\n" + \
...
def help_command(message):
    cid = message.chat.id
    bot.send_message(cid, "🔰 თუ გინდა იცოდე რამდენი დააგროვე *CAKE, bOPEN, DODO, SWINGBY, BRY, ZEE, SWGB, SFP, LINA, LIT, HGET, BDO, EGLD, UST და DITTO* Pool-ში მაშინ უბრალოდ მისამართი მომწერე." + "\n" + "\n" + \
...
def send_pcs_info(message: Message):
    try:
        ...
        contract_names = ["CAKE", "DITTO", "BDO", "EGLD", "UST", "WSOTE", "FRONT", "HELMET", "BTCST", "BSCEX", "TEN", "ALBT", "ZEE", "BRY", "SWINGBY", "DODO", "BOPEN"]
